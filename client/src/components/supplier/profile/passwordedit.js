...
class Editsuppassword extends Component {
    constructor(props) {
        super(props)
        this.state = {
            password:'',
                    ...
                    <div className="container">
                        ...
                        <div className="collapse navbar-collapse" id="myNavbar">
                            <ul className="nav navbar-nav navbar-right">
                                ...
                                <li><a href="/supplierlog">SIGNIN</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:4000/book/getpwd", {
            method: "POST",
            headers: {
    ...
    handleSubmit(e) {
        ...
        if (this. handleValidation()) {
            ...
            fetch("http://localhost:4000/book/resetsuppwd/"+this.props.match.params.id+"/"+this.props.match.params.password, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
                            ...
                            <div className="col-md-8">
                                ...
                                <div className="editbuttongroup">
                                    <div className="viewbutton">
                                        <Link to={"/"  } className="glyphicon glyphicon-circle-arrow-right">Home</Link>
                                    </div>
                                </div>
                                <hr />
                            </div>
...
export default Editsuppassword;
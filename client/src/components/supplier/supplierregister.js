...
class Supplierregister extends Component {
    ...
    handleSubmit(e) {
        ...
        if (this.handleValidation()) {
            ...
            fetch("http://localhost:4000/book/Supplierreg", {
                method: "POST",
                headers: {
            ...
            <div>
                <div className="container">
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <div className="form-group col-md-8">
                            <label htmlFor="exampleFormControlInput2">City :</label>
                            <input type="text" className="form-control" id="exampleFormControlInput9" name="city" placeholder=" city" value={this.state.city} onChange={this.handleChange} />

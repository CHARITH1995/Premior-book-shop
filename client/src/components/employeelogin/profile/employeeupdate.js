...
class Employeeprofile extends Component {
    ...
    componentDidMount() {
        var authToken = localStorage.token;
        fetch("http://localhost:4000/book/employee/" + localStorage.token, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                'Authorization': authToken
                        ...
                        <div className="col-sm-8">
                            ...
                            <div className="editbuttongroup">
                                    <div className="viewbutton">
                                        <Link to={"/editpassword/"+ this.state._id+"/"+this.state.password  } className="glyphicon glyphicon-circle-arrow-right">EditPassword</Link>
                                    </div>
                                </div>
                        </div>
                    </div>
